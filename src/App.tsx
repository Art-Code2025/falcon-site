  ...
  return (
    <div className="min-h-screen bg-gray-900">
          ...
          <div className="flex justify-between items-center h-20">
              ...
              <div className="flex-shrink-0">
                <div className="flex items-center">
                  ...
                  <div className="relative w-10 h-10 mr-3">
                    ...
                    <div className="absolute top-1 left-1 w-8 h-8 bg-gradient-to-br from-gray-300 to-gray-500 transform rotate-45 rounded-sm shadow-inner"></div>
                  </div>
                  <div>
                    <h1 className="text-2xl font-bold text-white tracking-wider">FALCONS</h1>
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <button onClick={() => scrollToSection('home')} className="text-gray-300 hover:text-white transition-all duration-300 text-sm font-medium">About</button>
                <button onClick={() => scrollToSection('services')} className="text-gray-300 hover:text-white transition-all duration-300 text-sm font-medium">Portfolio</button>
                <button onClick={() => scrollToSection('about')} className="text-gray-300 hover:text-white transition-all duration-300 text-sm font-medium">Investments</button>
                <button onClick={() => scrollToSection('team')} className="text-gray-300 hover:text-white transition-all duration-300 text-sm font-medium">Partnering</button>
                <button onClick={() => scrollToSection('contact')} className="text-gray-300 hover:text-white transition-all duration-300 text-sm font-medium">News</button>
                <button onClick={() => scrollToSection('contact')} className="text-gray-300 hover:text-white transition-all duration-300 text-sm font-medium">Contact</button>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="bg-white/10 backdrop-blur-md text-white px-6 py-2 rounded-full text-sm font-medium border border-white/20 hover:bg-white/20 transition-all duration-300">
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-900/95 backdrop-blur-md border-t border-gray-800">
              <button onClick={() => scrollToSection('home')} className="block w-full text-left px-3 py-2 text-gray-300 hover:text-white transition-colors duration-200">About</button>
              <button onClick={() => scrollToSection('services')} className="block w-full text-left px-3 py-2 text-gray-300 hover:text-white transition-colors duration-200">Portfolio</button>
              <button onClick={() => scrollToSection('about')} className="block w-full text-left px-3 py-2 text-gray-300 hover:text-white transition-colors duration-200">Investments</button>
              <button onClick={() => scrollToSection('team')} className="block w-full text-left px-3 py-2 text-gray-300 hover:text-white transition-colors duration-200">Partnering</button>
              <button onClick={() => scrollToSection('contact')} className="block w-full text-left px-3 py-2 text-gray-300 hover:text-white transition-colors duration-200">Contact</button>
            </div>
          </div>
        )}
      </nav>
      ...
      <section id="home" className="relative min-h-screen flex items-center bg-gray-900 text-white overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 w-32 h-32 opacity-30 animate-float">
          <div className="w-full h-full bg-gradient-to-br from-blue-400 to-blue-600 transform rotate-45 rounded-lg shadow-2xl"></div>
        </div>
        <div className="absolute bottom-1/3 right-1/3 w-24 h-24 opacity-20 animate-float" style={{animationDelay: '2s'}}>
          <div className="w-full h-full bg-gradient-to-br from-gray-400 to-gray-600 transform rotate-12 rounded shadow-2xl"></div>
        </div>
        
        {/* Large 3D Triangle */}
        <div className="absolute right-20 top-1/2 transform -translate-y-1/2 opacity-40">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-4xl">
            <p className="text-blue-400 text-sm font-medium mb-6 tracking-widest uppercase animate-fadeInUp">
              PEOPLE ARE THE MOST IMPORTANT INVESTMENT
            </p>
            <h1 className="text-6xl md:text-8xl font-bold mb-8 leading-tight animate-fadeInUp delay-300">
              <span className="block">WE BUILD</span>
              <span className="block">BUSINESS</span>
              <span className="block text-blue-400">WITH YOU</span>
            </h1>
            <p className="text-xl text-gray-300 mb-10 max-w-2xl leading-relaxed animate-fadeInUp delay-500">
              We are FALCONS and we empower Industrial Growth
            </p>
            <button
              onClick={() => scrollToSection('contact')}
              className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105 inline-flex items-center animate-fadeInUp delay-1000 shadow-2xl"
            >
              Contact us
            </button>
          </div>
      ...
      <section id="about" className="py-20 bg-gray-100 relative">
        ...
        <div className="absolute top-0 left-0 w-full h-32 bg-white transform -skew-y-2 origin-top-left"></div>
            ...
            <div className={`transition-all duration-1000 ${isVisible.about ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              <div className="mb-8">
                <div className="flex items-center mb-6">
                  <div className="text-6xl font-bold text-blue-600 mr-6">15</div>
                  <div>
                    <p className="text-lg font-semibold text-gray-900">Years</p>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600 mb-1">2004</div>
                    ...
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600 mb-1">HK</div>
                      <div className="text-xs text-gray-600 uppercase tracking-wide">REGISTERED</div>
                    </div>
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600 mb-1">CN</div>
                      <div className="text-xs text-gray-600 uppercase tracking-wide">SUPPLIERS</div>
                    </div>
                  </div>
                  
                  <h4 className="text-lg font-bold text-gray-900 mb-4">Our Business Areas</h4>
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-blue-600 rounded-full mr-3"></div>
                      <span className="text-gray-700">Furniture Trading</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-blue-600 rounded-full mr-3"></div>
                      <span className="text-gray-700">Building Materials</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-blue-600 rounded-full mr-3"></div>
                      <span className="text-gray-700">Cosmetics</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`text-4xl md:text-5xl font-bold text-gray-900 mb-4 transition-all duration-1000 ${isVisible.services ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              Transformative Investments
            </h2>
            <p className="text-xl text-gray-600">The finest business consulting services in the area</p>
          </div>

          {/* Services Grid */}
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className={`bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-500 hover:transform hover:-translate-y-2 ${isVisible.services ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className={`bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-500 hover:transform hover:-translate-y-2 delay-200 ${isVisible.services ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className={`bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-500 hover:transform hover:-translate-y-2 delay-400 ${isVisible.services ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <div className="text-gray-600 mb-6 text-left text-sm">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white">
                  <h3 className="text-3xl font-bold mb-4">Transform your business</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-semibold transition-all duration-300 mb-8">
                Contact us
              </button>

              {/* Navigation Arrows */}
              <div className="flex space-x-4">
                <button className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/20 transition-all duration-300">
                  <ChevronLeft size={20} />
                </button>
                <button className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/20 transition-all duration-300">
            ...
            <div className="relative">
              <div 
                className="h-80 bg-cover bg-center rounded-2xl relative overflow-hidden"
                style={{
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-gray-900/80 backdrop-blur-md rounded-lg p-6">
                    <h4 className="text-2xl font-bold text-white mb-2">Human Capital</h4>
                    ...
                    <button className="text-blue-400 font-semibold hover:text-blue-300 transition-colors duration-200 border-b border-blue-400">
                      Read more
                    </button>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gray-800 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="mb-16">
            <h3 className="text-sm font-medium mb-4 tracking-wider uppercase text-gray-400">TARGETED SECTORS</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="mb-6">
                <h4 className="text-lg font-light text-gray-400 mb-2">Value-added</h4>
                <h3 className="text-4xl font-bold">Distribution</h3>
              </div>
            ...
            <div className="text-center">
              <div className="mb-6">
                <h4 className="text-lg font-light text-gray-400 mb-2">Industrial</h4>
      ...
      <section id="team" className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`text-4xl md:text-5xl font-bold text-gray-900 mb-4 transition-all duration-1000 ${isVisible.team ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              Testimonials
              <span className="block text-2xl font-normal text-gray-600">& Client Success Stories</span>
            </h2>
          </div>
          
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto mb-16">
            <div className={`bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-500 hover:transform hover:-translate-y-2 ${isVisible.team ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
                  <div className="w-6 h-6 bg-blue-500 rounded-full"></div>
                </div>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Zailai Shouki</h3>
            ...
            <div className={`bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-500 hover:transform hover:-translate-y-2 delay-200 ${isVisible.team ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Minna Gou</h3>
              <p className="text-blue-600 font-semibold mb-4">Marketing Assistant</p>
              <p className="text-gray-600">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="font-semibold text-gray-900">- Business Client</div>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="font-semibold text-gray-900">- Trading Partner</div>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="font-semibold text-gray-900">- Construction Company</div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="flex justify-center items-center space-x-8 opacity-60">
              <div className="text-2xl font-bold text-gray-400">Technologies</div>
              <div className="text-2xl font-bold text-gray-400">duo.fi</div>
      ...
      <section className="py-20 bg-gray-800 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-blue-600 rounded mr-3 flex items-center justify-center">
                  <div className="w-5 h-5 bg-white transform rotate-45 rounded-sm"></div>
                </div>
                <div>
                  <h1 className="text-2xl font-bold tracking-wider">FALCONS</h1>
                  <p className="text-xs text-gray-400 tracking-widest">CAPITAL</p>
                </div>
              </div>
            ...
            <div>
              <div className="mb-8">
                <h3 className="text-sm font-medium mb-4 tracking-wider uppercase text-gray-400">SIGN UP TO OUR NEWSLETTER:</h3>
                <div className="flex items-center bg-white/10 backdrop-blur-md rounded-full p-2">
                  <input
                    type="email"
                    placeholder="your@email.com"
                    className="flex-1 bg-transparent text-white placeholder-gray-400 px-4 py-2 focus:outline-none text-lg italic"
                  />
                  <button className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-all duration-300">
                    <ArrowRight size={20} />
                  </button>
                </div>
                <div className="flex items-center mt-4">
                  <input type="checkbox" className="mr-3" />
                  <span className="text-sm text-gray-400">I have read and accept the Terms & Privacy</span>
                </div>
              </div>
            </div>
          </div>
