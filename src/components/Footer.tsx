        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-12 md:mb-20">
          ...
          <div className="flex flex-col gap-8 animate-fadeInLeft">
            <div className="flex items-center gap-4 mb-2">
              <img src="/logo.png" alt="Falcons Logo" className="h-16 w-auto md:h-20" style={{filter:'drop-shadow(0 2px 8px #0002)'}} />
          ...
          <div className="flex flex-col gap-8 animate-fadeInRight delay-300">
            <div>
              <h3 className="text-lg font-semibold mb-3 tracking-wider uppercase text-gray-700">{t('footer.newsletter.title')}</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-4">
              <div>
                <h4 className="font-semibold mb-2 text-gray-700">{t('footer.links.about')}</h4>
              ...
              <div>
                <h4 className="font-semibold mb-2 text-gray-700">{t('footer.links.contact')}</h4>
                <ul className="space-y-1 text-gray-600 text-sm">
              ...
              <div>
                <h4 className="font-semibold mb-2 text-gray-700">{t('footer.links.legal')}</h4>
                <ul className="space-y-1 text-gray-600 text-sm">
